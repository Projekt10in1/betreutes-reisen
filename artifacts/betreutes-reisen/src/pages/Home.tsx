...
import { Heart, ShieldCheck, Map } from "lucide-react";
          ...
          <div className="max-w-3xl">
            ...
            >
              <Link href="/reisen">
                <Button
                  size="lg"
                  className="text-lg px-8 h-14 rounded-full shadow-md hover:shadow-lg transition-all font-bold"
              ...
              <Link href="/kontakt">
                <Button
                  variant="outline"
                  size="lg"
                  className="text-lg px-8 h-14 rounded-full bg-background/80 backdrop-blur border-2 border-primary/20 hover:border-primary"
      ...
      <section className="py-20 bg-accent/20 border-y">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="bg-card border rounded-xl p-6 min-w-[200px] shadow-sm" data-testid="stat-total-trips">
              <div className="text-4xl font-extrabold text-primary mb-2">{tripsSummary.totalTrips}</div>
              <div className="text-muted-foreground font-medium">Reisen geplant</div>
            </div>
            <div className="bg-card border rounded-xl p-6 min-w-[200px] shadow-sm" data-testid="stat-long-trips">
              <div className="text-4xl font-extrabold text-secondary mb-2">{tripsSummary.longTrips}</div>
              <div className="text-muted-foreground font-medium">Mehrtägige Reisen</div>
            </div>
            <div className="bg-card border rounded-xl p-6 min-w-[200px] shadow-sm" data-testid="stat-short-trips">
              <div className="text-4xl font-extrabold text-accent-foreground mb-2">{tripsSummary.shortTrips}</div>
              <div className="text-muted-foreground font-medium">Kurztrips</div>
            </div>
          </div>
          <div className="mt-12">
            <Link href="/reisen">
              <Button size="lg" className="font-bold h-14 px-8 rounded-full" data-testid="button-discover-trips">
